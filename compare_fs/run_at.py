...
def run_input( run_fs, msusy, ma2, tan_beta, at ):
  mu = msusy

  print(at)
  sys.stdout.flush()
  
  template_file_name = 'ms_tb_ma2_at_mu'
...
if __name__ == '__main__':
  ...
  msusy_range = numpy.array( [5000, 5000] )
  ma_range = numpy.array( [900, 900] )
  tan_beta_range = numpy.array( [10, 10] )
  xt_range = numpy.array( [-5000, 5000] )
